...
public final class PathOfTheAnimist extends CardImpl {
  ...
  public PathOfTheAnimist(UUID ownerId, CardSetInfo setInfo) {
    ...
    this.getSpellAbility().addEffect(
        new SearchLibraryPutInPlayEffect(new TargetCardInLibrary(0, 2, StaticFilters.FILTER_CARD_BASIC_LAND), true));

    // Will of the Planeswalkers — Starting with you, each player votes for
    // planeswalk or chaos. If planeswalk gets more votes, planeswalk. If chaos gets
    // more votes or the vote is tied, chaos ensues.
